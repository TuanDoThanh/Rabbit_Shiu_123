              ...
              <div className="row login-form">
                <div className="col-md-12">
                  <div className="col-md-4">
                    <span>
                      Ngày: {new Date(element.date).toDateString("yyyy-MM-dd")}
                    </span>
                  </div>
                  <div className="col-md-4">
                    <p className="cart_total_price total-bill">
                      Tổng: {this.caculatorTotalBill(element.products)}
                      <sup>đ</sup>
                    </p>
                  </div>
                  <div className="col-md-4">
